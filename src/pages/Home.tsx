import { appNameEnglish, appNameKorean } from "@/constants";
...
const Button = ({ children }: { children: React.ReactNode }) => (
  <div
    className="m-[5px] h-[fit-content] p-[10px] bg-transparent border-[none] rounded flex flex-row items-center gap-[10px] shadow">
    {children}
  </div>
);
  ...
  <div className="flex flex-row justify-center">
    <div className="max-w-screen-lg box-border p-[16px] flex flex-col items-center gap-[16px]">
      ...
      <h1 className="w-[fit-content] text-[2rem] font-bold flex flex-row items-baseline justify-center gap-[10px]">
        {"#" + appNameKorean}
        <sub className="text-[0.5em] opacity-50">{appNameEnglish.toLowerCase()}</sub>
      </h1>
